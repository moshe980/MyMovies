...
//	private AtomicLong counter;
	...
	public List<InstanceBoundary> getAllInstanceByName(String userDomain, String userEmail, String name, int size, int page) {
		...
		if (userBoundary.getRole().equals(UserRole.MANAGER.name())) {
			...
			List<InstanceEntity> resultPage = this.instanceDao.findAllByNameStartingWith(name,pageable);
			
			if(resultPage.isEmpty()) {
				throw new RuntimeException("culd not find thie movie in the list!");
			...
			List<InstanceEntity> resultPage = this.instanceDao.findAllByNameStartingWithAndActive(name,true,pageable);
