...
public interface InstanceDao extends MongoRepository<InstanceEntity, String>	{
    ...
    public List<InstanceEntity> findAllByNameStartingWith(@Param("name") String name,Pageable pageable);

    public List<InstanceEntity> findAllByNameStartingWithAndActive(@Param("name") String name,@Param("active") boolean active,Pageable pageable);
